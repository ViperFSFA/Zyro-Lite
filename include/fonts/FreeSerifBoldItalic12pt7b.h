// Vendored from GFX Library for Arduino's bundled examples
// (.pio/libdeps/t-deck-plus/GFX Library for Arduino/examples/HelloWorldGfxfont/)
// Adafruit-GFX-format font (GFXfont) - works directly with gfx->setFont().
